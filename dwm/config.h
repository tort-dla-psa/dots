...
/* appearance */
static const char font[] = "Liberation Mono:size=11:antialias=true:autohint=true";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", font, "-nb", bg0, "-nf", fg0, "-sb", accent, "-sf", bg1, NULL };
